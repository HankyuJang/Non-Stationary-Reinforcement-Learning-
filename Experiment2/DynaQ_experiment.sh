...
# make clean
# make FILES="EnvBusSpeed8.cxx ExpBusGridworld.cxx AgentDynaQ_psweep.cxx utils.c"
# ./RL_Exp 0 0.05 5 2000 1.0 0.5 value/DynaQ_value_2000_e0_a005_bs8.dat steps/DynaQ_steps_2000_e0_a005_bs8.dat DynaQ_cumsteps.dat
...
do
    ...
    do
        ...
        do
            ...
            do
                #for theta in -1.6 -0.8 -0.4 #0.05 0.1 0.2 0.4 0.8
                #do
                e_str="${epsilon//./}"
                a_str="${alpha//./}"
                t_str="${theta//./}"
