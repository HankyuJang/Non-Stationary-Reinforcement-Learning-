...
# make clean
# make FILES="EnvBusSpeed8.cxx ExpBusGridworld.cxx AgentQ.cxx utils.c"
# ./RL_Exp 0 0.05 0 2000 1.0 0 value/Q_value_2000_e0_a005_bs8.dat steps/Q_steps_2000_e0_a005_bs8.dat Q_cumsteps.dat

# epsilon = {0, 0.05, 0.1}
# alpha = {0.05, 0.1, 0.2, 0.4, 0.8, 1.0}

discount=1.0
# Q-learning doesn't have parameters n and theta
n=0
theta=0
