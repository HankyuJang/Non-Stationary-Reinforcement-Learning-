/*
 ...
 Bus speed: 1 to 8 (after 2000 episodes)
 Reward: 0 (every step)
         1 (terminal state)
 */
...
const observation_t* env_start()
{
    ...
    int stp1 = S_STATE;
    //if (RL_num_episodes() > 2000)
        //epsilon *= 0.99;
    //if (RL_num_episodes() > 2000 && RL_num_episodes() < 2500){
        //printf("%.3g ",epsilon);
    //}
...
const reward_observation_terminal_t *env_step(const action_t *this_action)
{
    ...
    //printf("bus: %d, agent: %d, action: %d\n", bus_loc, stp1, atp1);
    //printf("bus: %d ", bus_loc);
