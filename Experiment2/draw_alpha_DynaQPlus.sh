...
do
    ...
    do
        python plot_alpha.py -s1 steps/DynaQPlus_steps_e005_a005_n${n}_${b_str}.dat -s2 steps/DynaQPlus_steps_e005_a01_n${n}_${b_str}.dat -s3 steps/DynaQPlus_steps_e005_a02_n${n}_${b_str}.dat -s4 steps/DynaQPlus_steps_e005_a04_n${n}_${b_str}.dat -s5 steps/DynaQPlus_steps_e005_a08_n${n}_${b_str}.dat -s6 steps/DynaQPlus_steps_e005_a10_n${n}_${b_str}.dat -t Cumulated_steps_to_goal -o plots/DynaQPlus_steps_e005_n${n}_${b_str}_alpha.png
    done  
done
