...
# make clean
# make FILES="EnvBusSpeed8.cxx ExpBusGridworld.cxx AgentESarsa.cxx utils.c"
# ./RL_Exp 0 0.05 0 2000 1.0 0 value/ESarsa_value_2000_e0_a005_bs8.dat steps/ESarsa_steps_2000_e0_a005_bs8.dat ESarsa_cumsteps.dat

# epsilon = {0, 0.05, 0.1}
# alpha = {0.05, 0.1, 0.2, 0.4, 0.8, 1.0}

discount=1.0
# ESarsa doesn't have parameters n and theta
n=0
theta=0
