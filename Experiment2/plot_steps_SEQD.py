...
def plot_steps(x1, x2, x3, x4, s_idx, e_idx, y_low, y_high, title, xlabel, ylabel, filename):
...
if __name__ == '__main__':
    ...
    plot_steps(X_s1, X_s2, X_s3, X_s4, s_idx, e_idx, y_low, y_high, args.title, "Episodes", "Steps per episode", args.output)
